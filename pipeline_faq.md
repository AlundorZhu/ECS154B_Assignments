...
4. For the first research question, should we provide reasoning to support our observations? Or, we only explain our reasoning when "Explain your reasoning" is in the question, right? Or, should we explain our reasoning for every single question? 
...
6. One question I have is am I supposed to write two different scripts, one for step 2 - the SinglecycleCPU and one for step 3 - the PipelineCPU, or should I have one script for both step 2 and step 3?
